...
<body>
	...
	<div class="products">
		<div class="container">
			<h1 class="lg-title" style="color: rgb(248, 26, 92)">Delicious Dishes with Delicious Offers</h1>
			<p class="text-light" style="color: rgb(248, 26, 92)">Lorem ipsum dolor sit amet consectetur
				adipisicing elit. Aspernatur quos sit consectetur, ipsa voluptatem
				vitae necessitatibus dicta veniam, optio, possimus assumenda
				laudantium. Temporibus, quis cum.</p>
			...
			<div class="product-items">
				...
				<div class="product">
					<div class="product-content">
						<div class="product-img">
							<img src="images/biryani-products.jpg" alt="product image">
						</div>
					...
					<div class="product-info">
						...
						<a href="#" class="product-name">Chicken Dum Biryani</a>
				...
				<div class="product">
					...
					<div class="product-info">
						...
						<a href="#" class="product-name">Boneless Chicken Breast</a>
						<p class="product-price">$ 150.00</p>
						<p class="product-price">$ 133.00</p>
					</div>
				</div>
				...
				<div class="product">
					<div class="product-content">
						<div class="product-img">
							<img src="images/frenchFries-products.jpg" alt="product image">
						</div>
						<div class="product-btns">
							<button type="button" class="btn-cart">
								add to cart <span><i class="fas fa-plus"></i></span>
					...
					<div class="product-info">
						...
						<a href="#" class="product-name">Potato French Fries</a>
						<p class="product-price">$ 150.00</p>
						<p class="product-price">$ 133.00</p>
					</div>
				</div>
				...
				<div class="product">
					<div class="product-content">
						<div class="product-img">
							<img src="images/fish-products.jpg" alt="product image">
						</div>
						<div class="product-btns">
							<button type="button" class="btn-cart">
								add to cart <span><i class="fas fa-plus"></i></span>
					...
					<div class="product-info">
						...
						<a href="#" class="product-name">Apollo Fish Boneless</a>
						<p class="product-price">$ 150.00</p>
						<p class="product-price">$ 133.00</p>
					</div>
			...
			<div class="product-collection-wrapper">
				...
				<div class="product-col-left flex">
					<div class="product-col-content">
						<h2 class="sm-title">Natural Veggies</h2>
						<h2 class="md-title">Natural Veggies</h2>
				...
				<div class="product-col-right">
					<div class="product-col-r-top flex">
						<div class="product-col-content">
							<h2 class="sm-title">Fresh Juicy Fruits</h2>
							<h2 class="md-title">Fruits and Fun</h2>
							<p class="text-light">Lorem ipsum dolor sit, amet consectetur
								adipisicing elit. Molestiae consequatur facilis eligendi
								quibusdam voluptatibus exercitationem autem voluptatum, beatae
								architecto odit, quisquam repellat. Deleniti, architecto ab.</p>
