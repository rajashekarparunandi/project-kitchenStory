	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="navbarScroll">
			<ul class="navbar-nav m-auto my-2 my-lg-0">
				...
				<li class="nav-item"><a class="nav-link" href="#trending">My
						Cart</a></li>
				<li class="nav-item"><a class="nav-link" href="#store"> My
						Orders </a></li>
				<li class="nav-item"><a class="nav-link" href="home.jsp#aboutUs">About Us</a></li>
				<li class="nav-item"><a class="nav-link" href="messageus.jsp">Message
						Us</a></li>
